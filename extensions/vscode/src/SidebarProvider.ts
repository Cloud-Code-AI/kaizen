...
import { ApiEndpoint } from './types';
import { TestManagementProvider } from './testManagement/testManagementProvider';
import { ChatRepoProvider } from './chatRepo/chatRepoProvider'; // Import ChatRepoProvider
import { DocManagementProvider } from './docManagement/docManagementProvider'; // Import DocManagementProvider
...
export class SidebarProvider implements vscode.WebviewViewProvider {
    ...
    private context: vscode.ExtensionContext;
    private testManagementProvider: TestManagementProvider;
    private chatRepoProvider: ChatRepoProvider; // Declare ChatRepoProvider
    private docManagementProvider: DocManagementProvider; // Declare DocManagementProvider
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        ${this.showHistory
            ...
            : `<div id="buttons">
               ...
               <button class="webview-button" data-webview="documentation">Doc Management [Coming Soon]</button>
               <button class="webview-button" data-webview="testManagement">Test Management [Coming Soon]</button>
               <button class="webview-button" data-webview="chatRepo">Chat Repo</button> <!-- New Button -->
               <button class="webview-button" data-webview="codeReview">Code Review [Coming Soon]</button>
             </div>`
          }
        <script nonce="${nonce}" src="${scriptUri}"></script>
