...
@mock.patch('kaizen.helpers.output.os.path.join', side_effect=lambda *args: '/'.join(args))
@mock.patch('kaizen.helpers.output.create_folder')
@mock.patch('kaizen.helpers.output.general.clean_python_code', side_effect=lambda code: code)
@mock.patch('kaizen.helpers.output.logger.info')
def test_create_test_files_normal_case(mock_logger_info, mock_clean_python_code, mock_create_folder, mock_path_join, tmp_path):
    json_tests = [
        {
            'folder_name': 'module1',
            'importance': 'High',
...
@mock.patch('kaizen.helpers.output.os.path.join', side_effect=lambda *args: '/'.join(args))
@mock.patch('kaizen.helpers.output.create_folder')
@mock.patch('kaizen.helpers.output.general.clean_python_code', side_effect=lambda code: '')
@mock.patch('kaizen.helpers.output.logger.info')
def test_create_test_files_failed_clean_code(mock_logger_info, mock_clean_python_code, mock_create_folder, mock_path_join, tmp_path):
    json_tests = [
        {
            'folder_name': 'module1',
            'importance': 'High',
...
@mock.patch('kaizen.helpers.output.general.clean_python_code', side_effect=lambda code: code)
@mock.patch('kaizen.helpers.output.logger.info')
def test_create_test_files_empty_tests(mock_logger_info, mock_clean_python_code, mock_create_folder, mock_path_join, tmp_path):
    json_tests = []
    folder_path = str(tmp_path)
...
@mock.patch('kaizen.helpers.output.general.clean_python_code', side_effect=lambda code: code)
@mock.patch('kaizen.helpers.output.logger.info')
def test_create_test_files_special_characters_in_test_name(mock_logger_info, mock_clean_python_code, mock_create_folder, mock_path_join, tmp_path):
    json_tests = [
        {
            'folder_name': 'module1',
            'importance': 'High',
